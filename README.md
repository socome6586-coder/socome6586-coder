...
Java와 Spring Boot 기반 웹 서비스를 기획부터 개발·배포까지 직접 경험한 백엔드 개발자입니다. 기존 홈페이지 운영자의 요청으로 실제 운영 중인 농업용 드론 쇼핑몰 라이트드론을 PHP에서 Spring Boot로 단독 재구축하며, 결제·인증·DB 마이그레이션처럼 운영에 필요한 기능을 직접 다뤄봤습니다.
...
**Links** · [운영 사이트](https://lightdrone.co.kr) · [GitHub](https://github.com/socome6586-coder/lightdrone)
...
**Links** · [sellerprofit.co.kr](https://sellerprofit.co.kr)
...
**Links** · [GitHub](https://github.com/ssm512/SBNPrj)
